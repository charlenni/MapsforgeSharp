...
//ORIGINAL LINE: public enum InternalRenderTheme implements XmlRenderTheme
	public enum InternalRenderTheme
	{
		/// <summary>
		/// A render-theme similar to the OpenStreetMap Osmarender style.
		/// </summary>
		/// <seealso cref= <a href="http://wiki.openstreetmap.org/wiki/Osmarender">Osmarender</a> </seealso>
