...
namespace org.mapsforge.map.reader
{
	...
	internal sealed class Deserializer
	{
		...
		internal static long GetFiveBytesLong(byte[] buffer, int offset)
		{
		...
		internal static int GetInt(byte[] buffer, int offset)
		{
		...
		///            the offset in the array. </param>
		/// <returns> the long value. </returns>
		internal static long GetLong(byte[] buffer, int offset)
		{
		...
		///            the offset in the array. </param>
		/// <returns> the int value. </returns>
		internal static int GetShort(byte[] buffer, int offset)
		{
